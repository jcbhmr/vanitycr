...
export type StartRuleNames = "Scope";
export interface ParseOptions<T extends StartRuleNames = "Scope"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"Scope">>(
  input: string,
  options?: Options,
