...
export type StartRuleNames = "Forwarded";
export interface ParseOptions<T extends StartRuleNames = "Forwarded"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"Forwarded">>(
  input: string,
  options?: Options,
