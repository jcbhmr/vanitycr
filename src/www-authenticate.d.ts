...
export type StartRuleNames = "WWWAuthenticate";
export interface ParseOptions<T extends StartRuleNames = "WWWAuthenticate"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"WWWAuthenticate">>(
  input: string,
  options?: Options,
